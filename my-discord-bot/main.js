...
client.on("messageCreate", async (msg) => {
    ...
    if (msg.content.startsWith("!")) {
        ...
        if (cmd === "!mania-addguild") {
            ...
            await setConfig(msg.guild.id, `mania_plan_channel_${key}`, planChannelId);
            if (notifyChannelId) await setConfig(msg.guild.id, `mania_notify_channel_${key}`, notifyChannelId);
